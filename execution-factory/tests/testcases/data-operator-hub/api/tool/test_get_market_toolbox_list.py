...
@allure.feature("工具注册与管理接口测试：在市场中获取工具箱列表")
class TestGetMarketToolboxList:
    ...
    @allure.title("在市场中获取工具箱列表，仅获取到已发布工具箱，默认从第一页开始，每页10个，按照更新时间倒序排列")
    def test_get_toolbox_list_01(self, Headers):
        ...
        for toolbox in toolboxlist["data"]:
            ...
            update_times.append(toolbox["update_time"])

        assert AssertTools.is_descending_str(update_times) == True

    @allure.title("page小于0，在市场中获取工具箱列表失败")
    ...
    @allure.title("page和page_size为0，在市场中获取工具箱列表，获取成功，采用默认值")
    ...
    @allure.title("page_size不在[1-100]内，在市场中获取工具箱列表失败")
    ...
    @allure.title("page_size在[1-100]内，在市场中获取工具箱列表成功")
    ...
    @allure.title("在市场中获取工具箱列表，排序字段不正确，获取失败")
    ...
    @allure.title("在市场中获取工具箱列表，排序顺序不正确，获取失败")
    ...
    @allure.title("在市场中获取工具箱列表，all为True获取所有工具箱，获取成功")
    ...
    @allure.title("在市场中获取工具箱列表，根据名称正序排列，获取成功")
    ...
    @allure.title("在市场中获取工具箱列表，根据名称获取工具箱，获取成功")
    ...
    @allure.title("在市场中获取工具箱列表，根据类型获取工具箱，获取成功")
