...
def migrate_data_source(conn):
    ...
    try:
        is_have_data_sql = """
            select * from adp.t_table where f_data_source_type_name in ('mysql','maria','oracle') and rownum <= 1
        """
...
select
	...
	f_update_time,
	f_update_user,
	CASE WHEN f_delete_time is null THEN 0 ELSE 1 END AS f_operation_type,
	2,
	1,
	f_scan_source
from
