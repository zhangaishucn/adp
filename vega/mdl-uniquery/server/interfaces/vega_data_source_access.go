...
//go:generate mockgen -source ../interfaces/vega_data_source_access.go -destination ../interfaces/mock/mock_vega_data_source_access.go
type VegaDataSourceAccess interface {
	GetDataSourceByID(ctx context.Context, dataSourceID string) (*VegaDataSource, error)
}
