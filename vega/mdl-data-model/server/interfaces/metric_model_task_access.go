...
//go:generate mockgen -source ../interfaces/metric_model_task_access.go -destination ../interfaces/mock/mock_metric_model_task_access.go
type MetricModelTaskAccess interface {
	CreateMetricTask(ctx context.Context, tx *sql.Tx, metricTasks MetricTask) error
