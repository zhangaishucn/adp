...
// var mongoConn = "mongodb://root:pwd@127.0.0.1:27017/automation?authSource=admin"
...
// 		ret[i].ShareData = &entity.ShareData{Dict: map[string]interface{}{
// 			"test": "gg",
// 		}}
