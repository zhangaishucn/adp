...
ALTER_TABLE_DICT = [
    ...
    ["workflow",    "t_automation_executor",          "COLUMN",   "MODIFY",     "f_name",         "VARCHAR(256 CHAR) NOT NULL DEFAULT ''",   "节点名称"],
    ["workflow",    "t_automation_executor",          "COLUMN",   "MODIFY",     "f_description",  "VARCHAR(1024 CHAR) NOT NULL DEFAULT ''",  "节点描述"],
    ["workflow",    "t_automation_executor_action",   "COLUMN",   "MODIFY",     "f_name",         "VARCHAR(256 CHAR) NOT NULL DEFAULT ''",   "动作名称"],
    ["workflow",    "t_automation_executor_action",   "COLUMN",   "MODIFY",     "f_description",  "VARCHAR(1024 CHAR) NOT NULL DEFAULT ''",  "动作描述"],
]
