...
export interface ContentAbstractParameters {
  docid: string;
  version: string;
}

export const ContentAbstractConfig = forwardRef<Validatable, ExecutorActionConfigProps<ContentAbstractParameters>>(({ t, parameters = {}, onChange }, ref) => {
  const [form] = Form.useForm<ContentAbstractParameters>();
