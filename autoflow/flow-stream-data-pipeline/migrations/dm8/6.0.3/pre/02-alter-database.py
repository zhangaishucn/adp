...
ALTER_TABLE_DICT = [
    ...
    ["workflow", "t_stream_data_pipeline",  "COLUMN", "ADD", "f_creator_type", "VARCHAR(20 CHAR) NOT NULL DEFAULT ''", "创建者类型"],
    ["workflow", "t_stream_data_pipeline",  "COLUMN", "ADD", "f_updater_type", "VARCHAR(20 CHAR) NOT NULL DEFAULT ''", "更新者类型"],
]
