...
ALTER_TABLE_DICT = [
    ...
    ["workflow", "t_stream_data_pipeline",  "COLUMN", "ADD", "f_creator", "varchar(40) NOT NULL DEFAULT ''", "创建者id"],
    ["workflow", "t_stream_data_pipeline",  "COLUMN", "ADD", "f_updater", "varchar(40) NOT NULL DEFAULT ''", "更新者id"],
]
