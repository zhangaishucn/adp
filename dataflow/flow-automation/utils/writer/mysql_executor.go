...
// MySQLExecutor MySQL执行器实现
type MySQLExecutor struct{}

func (e *MySQLExecutor) ExecuteInsert(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, data []map[string]interface{}) (*ExecutionResult, error) {
	return e.executeMySQLInsert(ctx, dbConn, tableInfo, driver, data)
}

func (e *MySQLExecutor) ExecuteUpdate(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, data []map[string]interface{}, where interface{}) (*ExecutionResult, error) {
	return e.executeMySQLUpdate(ctx, dbConn, tableInfo, driver, data, where)
}

func (e *MySQLExecutor) ExecuteDelete(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, where interface{}) (*ExecutionResult, error) {
	return e.executeMySQLDelete(ctx, dbConn, tableInfo, driver, where)
}

// executeMySQLInsert 执行MySQL插入操作
func (e *MySQLExecutor) executeMySQLInsert(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, data []map[string]interface{}) (*ExecutionResult, error) {
...
// executeMySQLUpdate 执行MySQL更新操作
func (e *MySQLExecutor) executeMySQLUpdate(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, data []map[string]interface{}, where interface{}) (*ExecutionResult, error) {
	fullTableName := driver.GetFullTableName(tableInfo)
	...
	if result.Error != nil {
		return nil, fmt.Errorf("MySQL update failed: %w", result.Error)
	}
...
// executeMySQLDelete 执行MySQL删除操作
func (e *MySQLExecutor) executeMySQLDelete(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, where interface{}) (*ExecutionResult, error) {
	fullTableName := driver.GetFullTableName(tableInfo)
	...
	if result.Error != nil {
		return nil, fmt.Errorf("MySQL delete failed: %w", result.Error)
	}
...
func (e *MySQLExecutor) executeBatchInsertWithDetails(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, data []map[string]interface{}, batchSize int) (int64, []map[string]interface{}, map[string]int) {
...
func (e *MySQLExecutor) executeIndividualInserts(ctx context.Context, dbConn *gorm.DB, tableInfo *TableInfo, driver DatabaseDriver, data []map[string]interface{}, failureReasons map[string]int) (int64, []map[string]interface{}, map[string]int) {
	var successCount int64
	var failedRecords []map[string]interface{}
...
// categorizeInsertError 分类插入错误类型 (MySQL版本)
func (e *MySQLExecutor) categorizeInsertError(err error) string {
	errStr := err.Error()
	...
	if strings.Contains(errStr, "unknown column") ||
		strings.Contains(errStr, "1054") { // MySQL unknown column error code
