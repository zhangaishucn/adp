...
import { renderIconDefinitionToSVGElement, HelperRenderOptions } from "../../templates/helpers";
...
export const useRender = ({ getIconDefinitionFromSource, renderOptions }: RenderOptions) =>
