...
const (
	// 概念索引名称
	KN_CONCEPT_INDEX_TEMP_NAME = "adp-kn_concept-temp"
	// 概念索引名称
...
var (
	...
	KN_CONCEPT_INDEX_TEMP = map[string]any{

		"index_patterns": []string{KN_CONCEPT_INDEX_NAME},
		"priority":       200,
		"template": map[string]any{
			"settings": KN_INDEX_SETTINGS,
			"mappings": map[string]any{
				"dynamic_templates": KN_INDEX_DYNAMIC_TEMPLATES,
				"properties":        KN_CONCEPT_INDEX_MAPPING,
			},
		},
	}
