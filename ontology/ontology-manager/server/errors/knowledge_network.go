...
const (
	...
	OntologyManager_KnowledgeNetwork_InvalidParameter_IncludeStatistics = "OntologyManager.KnowledgeNetwork.InvalidParameter.IncludeStatistics"
	...
	OntologyManager_KnowledgeNetwork_InternalError_GetActionTypesTotalFailed   = "OntologyManager.KnowledgeNetwork.InternalError.GetActionTypesTotalFailed"
	OntologyManager_KnowledgeNetwork_InternalError_GetObjectTypesTotalFailed   = "OntologyManager.KnowledgeNetwork.InternalError.GetObjectTypesTotalFailed"
	OntologyManager_KnowledgeNetwork_InternalError_GetRelationTypesTotalFailed = "OntologyManager.KnowledgeNetwork.InternalError.GetRelationTypesTotalFailed"
...
var (
	KNErrCodeList = []string{
		...
		OntologyManager_KnowledgeNetwork_InvalidParameter_IncludeStatistics,
		...
		OntologyManager_KnowledgeNetwork_InternalError_GetActionTypesTotalFailed,
		OntologyManager_KnowledgeNetwork_InternalError_GetObjectTypesTotalFailed,
		OntologyManager_KnowledgeNetwork_InternalError_GetRelationTypesTotalFailed,
