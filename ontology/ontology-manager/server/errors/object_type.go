...
const (
	...
	OntologyManager_ObjectType_NullParameter_DisplayKey          = "OntologyManager.ObjectType.NullParameter.DisplayKey"
...
var (
	ObjectTypeErrCodeList = []string{
		...
		OntologyManager_ObjectType_NullParameter_DisplayKey,
