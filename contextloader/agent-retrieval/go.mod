module devops.aishu.cn/AISHUDevOps/DIP/_git/agent-retrieval

go 1.23.7

require (
	devops.aishu.cn/AISHUDevOps/DIP/_git/mdl-go-lib v0.0.31
	devops.aishu.cn/AISHUDevOps/ONE-Architecture/_git/TelemetrySDK-Go.git/span/v2 v2.9.1
...
require (
	...
	devops.aishu.cn/AISHUDevOps/ONE-Architecture/_git/proton-rds-sdk-go v1.3.6 // indirect
